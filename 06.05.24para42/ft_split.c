...
/*   Updated: 2024/04/24 21:42:48 by pamarti2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*conditionals(const char *s, char c, char **array_strings, int j)
{
	int	movement;
...
int	first_steps(char **array_strings, const char *s, char c, int j)
{
	if (*s != c && *s != '\0')
	{
